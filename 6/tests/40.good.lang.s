...
mov 16(%ebx), %ebx
push 16(%ebx)
# MemberAccess Endsmember4.member4
pop %eax
mov %eax, -4(%ebp)
# Assignment Ends
# Assignment
...
mov 16(%ebx), %ebx
push 20(%ebx)
# MemberAccess Endsmember4.member5
pop %eax
mov $0, %ebx
cmp %eax, %ebx
je else_33
