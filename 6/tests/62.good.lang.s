...
mov -24(%ebp), %ebx
push 20(%ebx)
# MemberAccess Endslocal5.member5
push $37
mov $0, %edx
pop %ebx
pop %eax
...
mov 28(%ebx), %ebx
push 16(%ebx)
# MemberAccess Endsmember7.member4
push $1
pop  %ebx
pop  %eax
or   %ebx, %eax
...
mov 28(%ebx), %ebx
push 4(%ebx)
# MemberAccess Endsmember7.member1
pop %eax
mov $0, %ebx
cmp %eax, %ebx
je else_24
...
mov 0(%ebx), %ebx
push 12(%ebx)
# MemberAccess Endsmember0.member3
pop  %eax
neg  %eax
push %eax
# Negation Ends
...
mov 0(%ebx), %ebx
push 24(%ebx)
# MemberAccess Endsmember0.member6
pop  %ebx
pop  %eax
cdq
idiv %ebx
...
mov 16(%ebx), %ebx
push 12(%ebx)
# MemberAccess Endsmember4.member3
pop %eax
mov %eax, -12(%ebp)
# Assignment Ends
# IfElse
...
mov 16(%ebx), %ebx
push 24(%ebx)
# MemberAccess Endsmember4.member6
pop  %ebx
pop  %eax
sub  %ebx, %eax
push %eax
