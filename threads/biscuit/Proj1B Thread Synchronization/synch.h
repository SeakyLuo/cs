...
private:
    ...
    int value;          // lock value, 0 for busy, 1 for free
...
public:
    ...
    // lock and going to sleep are *atomic* in Wait(). ConditionLock must
    // be held by the currentThread for all of these operations.
